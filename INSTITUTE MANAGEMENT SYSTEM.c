...
void main()
{
        ...
        if(lgs)             //lgs ==> login sucess
        {
            ...
            printf("\t\t2. If you are new user You are Signup Sucessfully\n\n");
...

{
    ...
    int u_p = 0;    //u_p User Name and Password
...
void pg_dip()
{
    ...
    printf("\t\t2. C ++  \t\t\t\t\t\n");
    printf("\t\t3. Embedded C \t\t\t\t\n");
    printf("\t\t4. Micro controller Micro processor \t\t\n");
    ...
    switch(opt)
    {
        case 1:
           printf("\nOFFLINE MODE:-\n\n");
           fee=50000;
           strcpy(mode,"Off-line mode");
           printf("\nTuition Fee\t\t:50,000\n");
           printf("Lab fee\t\t\t:2,000\n");
           printf("Study Material fee\t:1,000\n\n");
           printf("TOTAL FEE\t\t:53,000/-");
           break;
        case 2:
           printf("\nONLINE MODE:-\n\n");
           fee=35000;
           strcpy(mode,"On-line mode");
           printf("\nTuition Fee\t\t:35,000\n");
           printf("Study Material fee\t:1,000\n\n");
           printf("TOTAL FEE\t\t:36,000/-");
           break;
        default:
            printf("Try again");
            goto mof;
...
void ai(){
    ...
    printf("\n\t\tArtificial Intelligence and Machine Learning-Course Modules\n\n");
    ...
    case 2:
           ...
           printf("\nTuition Fee\t\t:45,000\n");
           printf("Study Material fee\t:1,000\n\n");
           printf("TOTAL FEE\t\t:46,000/-");
           break;
    default:
            printf("Try again");
            goto mof2;
    }
    char course_name[100]="Artificial Intelligence and Machine Learning";
    char user_name[100];
    printf("\n\n\nPress 1 to pay the fee :");
    scanf("%d",&opt);
    if(opt==1){
